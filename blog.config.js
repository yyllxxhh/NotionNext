...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '星星之火，可以燎原',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'INvain', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '如果有一天', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://invain.xyz', // 网站地址
